...
cmd_dict[r"echo -e \\x77\\x65\\x6c\\x63\\x30\\x6d\\x65"+"\x0d\x0a"] = r"echo -e \\x77\\x65\\x6c\\x63\\x30\\x6d\\x65"+"\x0d\x0awelc0me\x0d\x0a"
...
class Handler(SocketServer.StreamRequestHandler):
    ...
    def handle(self):
        ...
        shell_path = "../etc/shell/sh"+str((self.targetPORT % 5) +1)+".txt"
        self.receiveQueue = []
        self.binary = ""
...
if __name__ == "__main__":
    ...
    print "=== Set up low honeypot(SHELL)  ==="
